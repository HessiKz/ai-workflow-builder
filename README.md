...
> Drag-drop LangChain workflow editor: chain prompts, tools, retrievers, and inspect the resulting DAG.

**Category:** AI / LangChain  
**Built with:** LangChain, LangSmith, Go, Vite, D3  
...
👉 https://HessiKz.github.io/ai-workflow-builder/

## Features

- Interactive, client-side visualisation of the AI / LangChain concept
...
git clone https://github.com/HessiKz/ai-workflow-builder.git
